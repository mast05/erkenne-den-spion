    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-10">
        ...
        <input
          ...
          maxLength={6}
          placeholder="ABC123"
          className="mt-2 w-full rounded-2xl border border-slate-800 bg-slate-900 px-5 py-4 text-center text-2xl font-black uppercase tracking-[0.2em] outline-none transition focus:border-emerald-500"
        />
        ...
        <button
          ...
          className="mt-4 w-full rounded-2xl border border-emerald-500/50 bg-emerald-500/10 px-6 py-5 font-black text-emerald-300 transition hover:bg-emerald-500/20 disabled:cursor-not-allowed disabled:opacity-40"
        >
          🚪 Raum beitreten
        </button>
